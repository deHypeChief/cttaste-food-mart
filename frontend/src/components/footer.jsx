...
export default function Footer() {
    return (
        <>
            <footer className="py-10 px-20 space-y-10 bg-white">
                <div>
                    <img src="/Logo.svg" className="size-20" alt="" />
                </div>

                <div className="grid grid-cols-[1fr_1fr_1fr_0.75fr] gap-10">
                    <div>
                        <h2 className="font-medium text-xl mb-3">About Us</h2>
                    ...
                    <div>
                        <h2 className="font-medium text-xl mb-3">Other Products</h2>
                    ...
                    <div>
                        <h2 className="font-medium text-xl mb-3">For Restaurants</h2>
                        <ul className="space-y-2 opacity-60">
                    ...
                    <div>
                        <h2 className="font-medium text-xl mb-3">Our Social Media</h2>
